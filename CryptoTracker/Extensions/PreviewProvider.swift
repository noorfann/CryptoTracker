...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$2.56tr", percentageChange: 15.0)
    let stat2 = StatisticModel(title: "24h Volume", value: "$256.56bn")
    let stat3 = StatisticModel(title: "BTC Dominance", value: "$2.56tr")
    let stat4 = StatisticModel(title: "Portfolio Value", value: "$2.56tr", percentageChange: -1.0)
